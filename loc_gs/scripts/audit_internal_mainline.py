...
INTERNAL_MAINLINE_RELATIVE_PATHS: tuple[str, ...] = (
    ...
    "gaussian/map.py",
    "gaussian/renderer.py",
    "gaussian/visibility.py",
    "sparse/audit.py",
    ...
    "students/candidate_mlp_scorer.py",
    ...
    "teacher/inlier_precision_feedback.py",
    "teacher/labels.py",
    ...
    "scripts/build_internal_sparse_failure_profile.py",
    "scripts/build_internal_inlier_precision_feedback.py",
    ...
    "scripts/train_internal_candidate_mlp_scorer.py",
